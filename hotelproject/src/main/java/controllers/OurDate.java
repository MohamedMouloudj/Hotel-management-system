...
public class OurDate {
    ...
    /**
     * if no date is provided then the current date is used (Calendar class is used
    ...
    /*
     * validate the input date , year and day and month should be in specified
     * ranges
     * consider leap years , if leap year or not then verify the month if it is
     * february
