...
/**
 * This class is responsible for connecting to the MongoDB database and retrieving the rooms from it. It holds the database connection .
    ...
    public static void retrieveRoomsFromDB(HashMap<String,Room> rooms) throws RetreiveFromDBException{
        ...
        try {
            ...
            while (cursor.hasNext()) {
                ...
                Room.idCounter = Math.max(Room.idCounter, Integer.parseInt(room.getRoomNumber().replaceAll("\\D+","")));
