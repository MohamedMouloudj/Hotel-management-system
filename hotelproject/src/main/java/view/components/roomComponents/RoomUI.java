...
public class RoomUI extends JPanel {
    ...
    RoomUI(RoomType roomType, String roomPicture, String roomDescription, double price) {
        ...
        bookButton.addActionListener(e -> {
            ...
            // this calculated price will have a different value depending on the date
            // children and adults
            double CalculatedPrice = price + 0.2 * AdultsCounter.getCount() + 0.15 * ChildrenCounter.getCount();// this
                                                                                                                // one
                                                                                                                // to
                                                                                                                // revise
