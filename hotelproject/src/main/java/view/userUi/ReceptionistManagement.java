...
public class ReceptionistManagement extends UserManagement {
        ...
        DocumentListener listener = new DocumentListener() {
            ...
            private void updateOasisMail() {
                ...
                txtOasisMail.setText(name + lastName
                        + (User.research("Receptionist", "lastName", lastName) != null
                                && User.research("Receptionist", "firstName", name) != null ? new Random().nextInt(100)
                                        : "")
                        + "@Oasis.dz");
            }
        };
    ...
    public String[][] getData() {
        return User.getAllExceptPassword("Receptionist", getColumnNames());
    }
    ...
    public JPanel addUser() {
        ...
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                } else if (User.research("Receptionist", "email", email) != null) {
